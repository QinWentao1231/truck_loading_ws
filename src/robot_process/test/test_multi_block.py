...
from rrt_env.environment_3D import RobotPosition, build_robot_positions
...
def make_block(box_type, box_w, n1, grab, t12, f13, car_w=4000):
    ...
    stack = [[0] * (n1 + 1) for _ in range(max(2, t12))]
    # 在第一个组边界放100%间隙（组间缝隙）
...
rp_list2 = build_robot_positions(config_rp)
rp_idx = 0
rp = rp_list2[rp_idx]
...
rp_list3 = build_robot_positions(single_cfg)
